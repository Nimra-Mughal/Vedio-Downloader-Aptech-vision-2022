...
//
        ...
        binding.vimeo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        binding.ytube.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//        ImageView twitter = findViewById(R.id.btnTwitter);
...
//        ImageView vimeo = findViewById(R.id.btnVimeo);
